...
const Footer = () => {
  return (
    <footer className="flex items-center justify-start flex-col lg:px-20 py-6 px-5 w-full gap-20 bg-slate-50">
      ...
      <div className="flex justify-between items-center max-sm:flex-col w-full text-sm font-normal">
        ...
        <p className="text-gray">
          <span className="text-black font-semibold">10,430</span> projects
          submitted
        </p>
      </div>
    </footer>
